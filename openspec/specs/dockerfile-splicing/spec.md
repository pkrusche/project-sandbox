...
Govern how a user-supplied `--dockerfile` is rendered into the generated sandbox image: dependency-stage insertion, prefix-stage inheritance, final-stage reconstruction, and preservation of custom Dockerfile compatibility.
